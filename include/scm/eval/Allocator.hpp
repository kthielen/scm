...
template <typename T>
    ...
    public:
		...
		bool operator==(const gcguard<T>& v) const { return p == v.p; }
...
public:
    ...
    template <typename T>
        T* allocate() { return Record(new (alloc(sizeof(T))) T); }

    template <typename T, typename A1>
        T* allocate(A1 a1) { return Record(new (alloc(sizeof(T))) T(a1)); }

    template <typename T, typename A1, typename A2>
        T* allocate(A1 a1, A2 a2) { return Record(new (alloc(sizeof(T))) T(a1, a2)); }

    template <typename T, typename A1, typename A2, typename A3>
        T* allocate(A1 a1, A2 a2, A3 a3) { return Record(new (alloc(sizeof(T))) T(a1, a2, a3)); }

    template <typename T, typename A1, typename A2, typename A3, typename A4>
        T* allocate(A1 a1, A2 a2, A3 a3, A4 a4) { return Record(new (alloc(sizeof(T))) T(a1, a2, a3, a4)); }

    template <typename T, typename A1, typename A2, typename A3, typename A4, typename A5>
        T* allocate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5) { return Record(new (alloc(sizeof(T))) T(a1, a2, a3, a4, a5)); }

    template <typename T, typename A1, typename A2, typename A3, typename A4, typename A5, typename A6>
        T* allocate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6) { return Record(new (alloc(sizeof(T))) T(a1, a2, a3, a4, a5, a6)); }

    template <typename T, typename A1, typename A2, typename A3, typename A4, typename A5, typename A6, typename A7>
        T* allocate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7) { return Record(new (alloc(sizeof(T))) T(a1, a2, a3, a4, a5, a6, a7)); }

    template <typename T, typename A1, typename A2, typename A3, typename A4, typename A5, typename A6, typename A7, typename A8>
        T* allocate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8) { return Record(new (alloc(sizeof(T))) T(a1, a2, a3, a4, a5, a6, a7, a8)); }
...
private:
    ...
    template <typename Key, typename V>
		std::map<Key, V>* flyweight_allocator() {
		    ...
		    void* mappy = alloc(sizeof(std::map<Key, V>) * 2);
